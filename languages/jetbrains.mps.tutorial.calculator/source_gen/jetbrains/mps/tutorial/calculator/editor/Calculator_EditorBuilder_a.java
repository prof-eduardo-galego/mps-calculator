...
/*package*/ class Calculator_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class inputFieldListHandler_uh00px_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.inputField$RyOJ;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.InputField$7_;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(inputFieldListHandler_uh00px_c0.this.getNode(), LINKS.inputField$RyOJ));
      try {
  ...
  private static class outputFieldListHandler_uh00px_e0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.outputField$NtP8;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.OutputField$7h;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(outputFieldListHandler_uh00px_e0.this.getNode(), LINKS.outputField$NtP8));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept InputField$7_ = MetaAdapterFactory.getConcept(0xaa123d6efbb1411fL, 0xa37772f5117888d8L, 0x641798472a650151L, "jetbrains.mps.tutorial.calculator.structure.InputField");
    /*package*/ static final SConcept OutputField$7h = MetaAdapterFactory.getConcept(0xaa123d6efbb1411fL, 0xa37772f5117888d8L, 0x641798472a656660L, "jetbrains.mps.tutorial.calculator.structure.OutputField");
  }
